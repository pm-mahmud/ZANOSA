...
export default function ProfileScreen() {
  ...
  const myPostedImages = [
    "https://www.pinkvilla.com/images/2025-04/1591273418_image-11.jpg",
    ...
    "https://images.news18.com/static-urdu/uploads/2025/07/Aneet-Padda-10-2025-07-c5a716363a3c392ca7845bfce65609b6.jpg",
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.profileSection}>
          ...
          <Text style={styles.userHandle}>@Pm's_Dream_Girl</Text>
